  ...
  return (
    <div className="header__nav">
      <nav className="main__nav">
        <ul>
          <li className="main__nav__notlink">
            <button className="main__nav__close"><span /><span /></button>
          </li>
      ...
      <div className="nav__social">
        <a className="nav__icon" href={props.social.vk} target="_blank">
          <svg>
            <use xlinkHref="img/sprite-icon.svg#icon-vk"></use>
          </svg>VK</a>
        <a className="nav__icon" href={props.social.instagram} target="_blank">
          <svg>
